...
#
#   OSDBuilder Script
#   Windows 10 Set-StartUpScriptDelay.ps1
#   Version 1
#
...
#======================================================================================
#
# Set Startup script delay to 0
# Assume Startup scripts to do other functions such as copying startmenu's or startlayouts


$RegCommands =
'add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Serialize" /v StartupDelayInMSec /t REG_DWORD /d 0 /f'
